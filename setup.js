    ...
    function (err) {
        if (err) {
            ...
            sql = [
                ...
                "USE calendarDb CREATE TABLE `UserAppointment` (`id` varchar(50) NOT NULL, `userId` varchar(50) NOT NULL,`appointmentId` varchar(50) NOT NULL,`state` varchar(50) NOT NULL,PRIMARY KEY (`userId`,`appointmentId`, `id`));",
